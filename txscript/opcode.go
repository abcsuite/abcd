...
const (
	...
	OP_NOP9                = 0xb8 // 184
	OP_NOP10               = 0xb9 // 185
	OP_SSTX                = 0xba // 186 Aero
	OP_SSGEN               = 0xbb // 187 Aero
	OP_SSRTX               = 0xbc // 188 Aero
	OP_SSTXCHANGE          = 0xbd // 189 Aero
	OP_CHECKSIGALT         = 0xbe // 190 Aero
	OP_CHECKSIGALTVERIFY   = 0xbf // 191 Aero
...
// This opcode is disabled in Aero, as it always returns an engine error.
