...
// This example demonstrates creating a script which pays to a abcd address.
// It also prints the created script hex and uses the DisasmString function to
// display the disassembled script.
func ExamplePayToAddrScript() {
	// Parse the address to send the coins to into a abcutil.Address
...
func ExampleSignTxOutput() {
	...
	addr, err := abcutil.NewAddressPubKeyHash(pubKeyHash,
	...
	// contains a single output that pays to address in the amount of 1 ABC.
	...
	lookupKey := func(a abcutil.Address) (chainec.PrivateKey, bool, error) {
