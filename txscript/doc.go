...
/*
Package txscript implements the abcd transaction script language.

This package provides data structures and functions to parse and execute
abcd transaction scripts.

Script Overview

Aero transaction scripts are written in a stack-base, FORTH-like language.

The abcd script language consists of a number of opcodes which fall into
...
The vast majority of Aero scripts at the time of this writing are of several
...
what conditions must be met in order to spend aero.
