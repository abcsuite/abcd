...
func TestWalletSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "accountbalance",
			newNtfn: func() (interface{}, error) {
				return abcjson.NewCmd("accountbalance", "acct", 1.25, true)
			},
			staticNtfn: func() interface{} {
				return abcjson.NewAccountBalanceNtfn("acct", 1.25, true)
			},
			marshalled: `{"jsonrpc":"1.0","method":"accountbalance","params":["acct",1.25,true],"id":null}`,
			unmarshalled: &abcjson.AccountBalanceNtfn{
				Account:   "acct",
				Balance:   1.25,
				Confirmed: true,
			},
		},
		{
			name: "abcdconnected",
			newNtfn: func() (interface{}, error) {
				return abcjson.NewCmd("abcdconnected", true)
			},
			staticNtfn: func() interface{} {
				return abcjson.NewBtcdConnectedNtfn(true)
			},
			marshalled: `{"jsonrpc":"1.0","method":"abcdconnected","params":[true],"id":null}`,
			unmarshalled: &abcjson.BtcdConnectedNtfn{
				Connected: true,
			},
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return abcjson.NewCmd("walletlockstate", true)
			},
			staticNtfn: func() interface{} {
				return abcjson.NewWalletLockStateNtfn(true)
			},
			marshalled: `{"jsonrpc":"1.0","method":"walletlockstate","params":[true],"id":null}`,
			unmarshalled: &abcjson.WalletLockStateNtfn{
				Locked: true,
			},
		},
		{
			name: "newtx",
			newNtfn: func() (interface{}, error) {
				return abcjson.NewCmd("newtx", "acct", `{"account":"acct","address":"1Address","category":"send","amount":1.5,"fee":0.0001,"confirmations":1,"txid":"456","walletconflicts":[],"time":12345678,"timereceived":12345876,"vout":789,"otheraccount":"otheracct"}`)
			},
			staticNtfn: func() interface{} {
				...
				return abcjson.NewNewTxNtfn("acct", result)
			},
			...
			unmarshalled: &abcjson.NewTxNtfn{
				Account: "acct",
				Details: abcjson.ListTransactionsResult{
					Account:         "acct",
					Address:         "1Address",
					Category:        "send",
					Amount:          1.5,
