...
/*
abcd is a full-node abcd implementation written in Go.

The default options are sane for most users.  This means abcd will work 'out of
...
parsed when abcd starts up.  By default, the configuration file is located at
~/.abcd/abcd.conf on POSIX-style operating systems and %LOCALAPPDATA%\abcd\abcd.conf
...
Application Options:
  ...
  -a, --addpeer=            Add a peer to connect with at startup
      ...
      --listen=             Add an interface/port to listen for connections
                            (default all interfaces port: 9527, testnet: 19527)
  ...
  -P, --rpcpass=            Password for RPC connections
      ...
      --rpclisten=          Add an interface/port to listen for RPC connections
                            (default port: 9528, testnet: 19529)
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in ABC/kB to be
