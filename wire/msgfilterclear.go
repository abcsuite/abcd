...
// MsgFilterClear implements the Message interface and represents a abcd
...
// NewMsgFilterClear returns a new abcd filterclear message that conforms to the Message
