...
// MsgBlock implements the Message interface and represents a abcd
...
// BtcDecode decodes from the abcd wire protocol as it was sent across the
...
// BtcEncode encodes the receiver to w using the abcd protocol encoding.
// This is part of the Message interface implementation.
...
// the abcd wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new abcd block message that conforms to the
