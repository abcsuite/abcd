...
func TestVersion(t *testing.T) {
	...
	tcpAddrMe := &net.TCPAddr{IP: net.ParseIP("127.0.0.1"), Port: 9527}
	me, err := NewNetAddress(tcpAddrMe, SFNodeNetwork)
	if err != nil {
		t.Errorf("NewNetAddress: %v", err)
	}
	tcpAddrYou := &net.TCPAddr{IP: net.ParseIP("192.168.0.1"), Port: 9527}
	...
	conn = &fakeConn{
		localAddr:  &net.UDPAddr{IP: net.ParseIP("127.0.0.1"), Port: 9527},
	...
	conn = &fakeConn{
		localAddr:  tcpAddrMe,
		remoteAddr: &net.UDPAddr{IP: net.ParseIP("192.168.0.1"), Port: 9527},
	}
	msg, err = NewMsgVersionFromConn(conn, nonce, lastBlock)
	if err != ErrInvalidNetAddr {
		t.Errorf("NewMsgVersionFromConn: expected error not received "+
...
func TestVersionOptionalFields(t *testing.T) {
	...
	uaVersion.UserAgent = "/abcdtest:0.0.1/"
...
var baseVersionEncoded = []byte{
	...
	0x25, 0x37, // Port 9527 in big-endian
	...
	0x2f, 0x61, 0x62, 0x63, 0x64, 0x74, 0x65, 0x73,
