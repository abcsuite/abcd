...
// MsgReject implements the Message interface and represents a abcd reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	plen := uint32(0)
	// Unfortunately the abcd protocol does not enforce a sane
...
// NewMsgReject returns a new abcd reject message that conforms to the
