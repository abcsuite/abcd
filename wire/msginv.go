...
// MsgInv implements the Message interface and represents a abcd inv message.
...
// NewMsgInv returns a new abcd inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new abcd inv message that conforms to the
