...
// a single abcd headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a abcd headers
...
// NewMsgHeaders returns a new abcd headers message that conforms to the
