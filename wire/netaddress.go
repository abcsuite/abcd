...
// maxNetAddressPayload returns the max payload size for a abcd NetAddress
...
type NetAddress struct {
	...
	// not present in the abcd version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The abcd protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Aero protocol mixes little and big endian.
