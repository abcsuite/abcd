...
// MsgGetData implements the Message interface and represents a abcd
...
// NewMsgGetData returns a new abcd getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new abcd getdata message that conforms to
