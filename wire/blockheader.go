...
// BlockHeader defines information about a block and is used in the abcd
...
// readBlockHeader reads a abcd block header from r.  See Deserialize for
...
// writeBlockHeader writes a abcd block header to w.  See Serialize for
