...
const DefaultUserAgent = "/abcwire:0.2.2/"

// MsgVersion implements the Message interface and represents a abcd version
...
// NewMsgVersion returns a new abcd version message that conforms to the
...
// and local address from conn and returns a new abcd version message that
