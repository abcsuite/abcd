...
// subversion would typically be something like "/abcd:0.7.2/" (15 bytes)
...
// MsgAlert  implements the Message interface and defines a abcd alert
// message.
//
...
// NewMsgAlert returns a new abcd alert message that conforms to the Message
