...
// ServiceFlag identifies services supported by a abcd peer.
...
// CurrencyNet represents which abcd network a message belongs to.
type CurrencyNet uint32

// Constants used to indicate the message abcd network.  They can also be
// used to seek to the next message when a stream's state is unknown, but
// this package does not provide that functionality since it's generally a
// better idea to simply disconnect clients that are misbehaving over TCP.
const (
	// MainNet represents the main abcd network.
...
// bnStrings is a map of abcd networks back to their constant names for
// pretty printing.
