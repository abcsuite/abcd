...
const (
	...
	DefaultMinRelayTxFee = abcutil.Amount(1e5)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee abcutil.Amount) int64 {
	...
	if minFee < 0 || minFee > abcutil.MaxAmount {
		minFee = abcutil.MaxAmount
	}
...
func checkInputsStandard(tx *abcutil.Tx, txType stake.TxType, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee abcutil.Amount) bool {
...
func checkTransactionStandard(tx *abcutil.Tx, txType stake.TxType, height int64,
	timeSource blockchain.MedianTimeSource,
	minRelayTxFee abcutil.Amount) error {
