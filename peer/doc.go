...
/*
Package peer provides a common base for creating and managing Aero network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the abcd wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe abcd peer for handling abcd
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of abcd protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling abcd protocol messages
...
caller to specify things such as the user agent name and version, the abcd
network to use, which services it supports, and callbacks to invoke when abcd
...
In order to do anything useful with a peer, it is necessary to react to abcd
...
For convenience, a callback hook for all of the currently supported abcd
...
function which allows a abclog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/abcsuite/abcd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
