...
// Peer provides a basic concurrent safe abcd peer for handling abcd
...
// callbacks for handling abcd protocol messages.
//
...
// newPeerBase returns a new base abcd peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound abcd peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound abcd peer.
