...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/abcsuite/abcd/peer)
...
```bash
$ go get -u github.com/abcsuite/abcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/abcsuite/abcd/peer#example-package--NewOutboundPeer)  
