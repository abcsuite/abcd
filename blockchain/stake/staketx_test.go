...
func TestIsSStx(t *testing.T) {
	var sstx = abcutil.NewTx(sstxMsgTx)
	...
	sstx = abcutil.NewTxDeep(sstxMsgTx)
...
func TestIsSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = abcutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = abcutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = abcutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = abcutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = abcutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = abcutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = abcutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = abcutil.NewTx(&tx)
	...
	var sstxWrongPrefix = abcutil.NewTx(&tx)
...
func TestIsSSGen(t *testing.T) {
	var ssgen = abcutil.NewTx(ssgenMsgTx)
	...
	ssgen = abcutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestIsSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = abcutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = abcutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = abcutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = abcutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = abcutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = abcutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = abcutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = abcutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = abcutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = abcutil.NewTx(&tx)
	...
	var ssgenLongDataPush1Length = abcutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = abcutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = abcutil.NewTx(&tx)
...
func TestIsSSRtx(t *testing.T) {
	var ssrtx = abcutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = abcutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = abcutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = abcutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = abcutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = abcutil.NewTx(&tx)
...
func TestVerifyRealTxs(t *testing.T) {
	...
	ssrtxTx := abcutil.NewTx(ssrtxMtx)
