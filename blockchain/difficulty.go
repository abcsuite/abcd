...
//
// This compact form is only used in abcd to encode unsigned 256-bit numbers
...
// CalcWork calculates a work value from difficulty bits.  Aero increases
...
// weighted averages.
//
// NOTE: This is the original stake difficulty algorithm that was used at Aero
// launch.
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) calcNextRequiredStakeDifficultyV1(curNode *blockNode) (int64, error) {
	...
	// Aero parameters, but might do weird things if you use custom
	// parameters.
	if curNode == nil ||
...
// of parameters using the algorithm.
//
...
// difficulty algorithm change for the provided network.
//
// This function is safe for concurrent access.
...
// algorithm by pretending the provided number of tickets
