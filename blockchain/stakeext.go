...
//
// This function is safe for concurrent access.
func (b *BlockChain) TicketsWithAddress(address abcutil.Address) ([]chainhash.Hash, error) {
	b.chainLock.RLock()
	sn := b.bestNode.stakeNode
	b.chainLock.RUnlock()
...
func (b *BlockChain) TicketPoolValue() (abcutil.Amount, error) {
	b.chainLock.RLock()
	sn := b.bestNode.stakeNode
	b.chainLock.RUnlock()
