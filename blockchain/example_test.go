...
// overview documentation describes, this includes all of the Aero consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// exists.
	genesisBlock := abcutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
...
func ExampleCompactToBig() {
	// Convert the bits from block 300000 in the main Aero block chain.
