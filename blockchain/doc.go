...
The abcd block handling and chain selection rules are an integral, and quite
likely the most important, part of abcd.  Unfortunately, at the time of
this writing, these rules are also largely undocumented and had to be
ascertained from the bitcoind source code.  At its core, abcd is a
...
Since this package does not deal with other abcd specifics such as network
