...
func dbAddTxIndexEntries(dbTx database.Tx, block, parent *abcutil.Block, blockID uint32) error {
	...
	regularTxTreeValid := abcutil.IsFlagSet16(block.MsgBlock().Header.VoteBits,
		abcutil.BlockValid)
	var parentRegularTxs []*abcutil.Tx
...
func dbRemoveTxIndexEntries(dbTx database.Tx, block, parent *abcutil.Block) error {
	regularTxTreeValid := abcutil.IsFlagSet16(block.MsgBlock().Header.VoteBits,
		abcutil.BlockValid)
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) ConnectBlock(dbTx database.Tx, block, parent *abcutil.Block, view *blockchain.UtxoViewpoint) error {
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) DisconnectBlock(dbTx database.Tx, block, parent *abcutil.Block, view *blockchain.UtxoViewpoint) error {
