...
func (idx *ExistsAddrIndex) ExistsAddress(addr abcutil.Address) (bool, error) {
...
func (idx *ExistsAddrIndex) ExistsAddresses(addrs []abcutil.Address) ([]bool, error) {
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) ConnectBlock(dbTx database.Tx, block, parent *abcutil.Block, view *blockchain.UtxoViewpoint) error {
	regularTxTreeValid := abcutil.IsFlagSet16(block.MsgBlock().Header.VoteBits,
		abcutil.BlockValid)
	var parentTxs []*abcutil.Tx
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) DisconnectBlock(dbTx database.Tx, block, parent *abcutil.Block, view *blockchain.UtxoViewpoint) error {
	return nil
}
