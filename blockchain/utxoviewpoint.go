...
func (view *UtxoViewpoint) AddTxOuts(tx *abcutil.Tx, blockHeight int64,
	blockIndex uint32) {
	msgTx := tx.MsgTx()
...
func (view *UtxoViewpoint) connectTransaction(tx *abcutil.Tx, blockHeight int64,
...
func (b *BlockChain) connectTransactions(view *UtxoViewpoint, block *abcutil.Block,
	parent *abcutil.Block, stxos *[]spentTxOut) error {
	...
	if parent != nil && block.Height() != 0 {
		...
		regularTxTreeValid := abcutil.IsFlagSet16(votebits, abcutil.BlockValid)
		if regularTxTreeValid {
...
func (b *BlockChain) disconnectTransactions(view *UtxoViewpoint,
	block *abcutil.Block, parent *abcutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactionSlice(transactions []*abcutil.Tx,
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB,
	block, parent *abcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *abcutil.Tx, treeValid bool) (*UtxoViewpoint,
	error) {
	b.chainLock.RLock()
