...
// impossible.
func checkCoinbaseUniqueHeight(blockHeight int64, block *abcutil.Block) error {
...
func IsFinalizedTransaction(tx *abcutil.Tx, blockHeight int64,
...
func (b *BlockChain) checkBlockContext(block *abcutil.Block, prevNode *blockNode, flags BehaviorFlags) error {
...
// block.
func ticketsRevokedInBlock(bl *abcutil.Block) []chainhash.Hash {
	var tickets []chainhash.Hash
	for _, stx := range bl.MsgBlock().STransactions {
...
func voteBitsInBlock(bl *abcutil.Block) []VoteVersionTuple {
...
func (b *BlockChain) maybeAcceptBlock(block *abcutil.Block,
