...
[![Build Status](https://travis-ci.org/abcsuite/abcd.png?branch=master)]
(https://travis-ci.org/abcsuite/abcd) [![ISC License]
(http://img.shields.io/badge/license-ISC-blue.svg)](http://copyfree.org)
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)]
(http://godoc.org/github.com/abcsuite/abcd/blockchain/chaingen)
...
* [Basic Usage Example]
  (http://godoc.org/github.com/abcsuite/abcd/blockchain/chaingen#example-package--BasicUsage)  
...
```bash
$ go get -u github.com/abcsuite/abcd/blockchain/chaingen
```
