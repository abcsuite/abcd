...
func BlockOneCoinbasePaysTokens(tx *abcutil.Tx,
	...
	for i, txout := range tx.MsgTx().TxOut {
		...
		addrLedger, err := abcutil.DecodeAddress(ledger[i].Address, params)
		if err != nil {
			return err
		}
...
func CoinbasePaysTax(subsidyCache *SubsidyCache, tx *abcutil.Tx, height uint32,
...
func CalculateAddedSubsidy(block, parent *abcutil.Block) int64 {
	var subsidy int64
