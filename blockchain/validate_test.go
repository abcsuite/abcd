...
func recalculateMsgBlockMerkleRootsSize(msgBlock *wire.MsgBlock) {
	tempBlock := abcutil.NewBlock(msgBlock)
...
func TestBlockValidationRules(t *testing.T) {
	...
	err = chain.CheckConnectBlock(abcutil.NewBlock(genesisBlock))
	if err == nil {
	...
	b1test := abcutil.NewBlock(noCoinbaseOuts1)
	...
	for i := 1; i < stakeEarlyTest; i++ {
		bl, err := abcutil.NewBlockFromBytes(blockChain[int64(i)])
		if err != nil {
	...
	b142test := abcutil.NewBlock(earlySSGen142)
	...
	b142test = abcutil.NewBlock(earlyBadVoteBits42)
	...
	block153, err := abcutil.NewBlockFromBytes(blockChain[int64(testsIdx1)])
	if err != nil {
		t.Errorf("NewBlockFromBytes error: %v", err.Error())
	}
	...
	b153test := abcutil.NewBlock(badMerkleRoot153)
	...
	b153test = abcutil.NewBlock(badDifficulty153)
	...
	b153test = abcutil.NewBlock(badBlockSize153)
	...
	b153test = abcutil.NewBlock(badHash153)
	...
	b153test = abcutil.NewBlock(missingParent153)
	...
	b153test = abcutil.NewBlock(badSubsidy153)
	...
	b153test = abcutil.NewBlock(badCBOutpoint153)
	...
	b153test = abcutil.NewBlock(badCBFraudProof153)
	...
	b153test = abcutil.NewBlock(badCBAmountIn153)
	...
	b153test = abcutil.NewBlock(badSBAmountIn153)
	...
	b153test = abcutil.NewBlock(badStakebaseOutpoint153)
	...
	b153test = abcutil.NewBlock(ssgenInRegular153)
	...
	b153test = abcutil.NewBlock(badStakebaseSS153)
	...
	b153test = abcutil.NewBlock(badStakebaseScr153)
	...
	b153test = abcutil.NewBlock(badSSRtxNum153)
	...
	b153test = abcutil.NewBlock(ssrtxPayeesMismatch153)
	...
	b153test = abcutil.NewBlock(badSSRtxPayee153)
	...
	b153test = abcutil.NewBlock(badSSRtx153)
	...
	b153test = abcutil.NewBlock(block153MsgBlock)
	_, _, err = chain.ProcessBlock(b153test, blockchain.BFNone)
	if err != nil {
	...
	b154test := abcutil.NewBlock(block154MsgBlock)
	...
	b154test = abcutil.NewBlock(notEnoughStake154)
	...
	b154test = abcutil.NewBlock(badFreshStake154)
	...
	b154test = abcutil.NewBlock(notEnoughVotes154)
	...
	b154test = abcutil.NewBlock(tooManyVotes154)
	...
	b154test = abcutil.NewBlock(nonChosenTicket154)
	...
	b154test = abcutil.NewBlock(wrongBlockVote154)
	...
	b154test = abcutil.NewBlock(votesMismatch154)
	...
	b154test = abcutil.NewBlock(badVoteBit154)
	...
	b154test = abcutil.NewBlock(badSStxCommit154)
	...
	b154test = abcutil.NewBlock(badSSGenPayee154)
	...
	b154test = abcutil.NewBlock(spendTaggedIn154)
	...
	b154test = abcutil.NewBlock(spendTaggedOut154)
	...
	b154test = abcutil.NewBlock(badFinalState154)
	...
	b154test = abcutil.NewBlock(badPoolSize154)
	...
	b154test = abcutil.NewBlock(errTxTreeIn154)
	...
	b154test = abcutil.NewBlock(badBlockHeight154)
	...
	b154test = abcutil.NewBlock(taxMissing154)
	...
	b154test = abcutil.NewBlock(expiredTx154)
	...
	b154test = abcutil.NewBlock(badValueIn154)
	...
	b154test = abcutil.NewBlock(badHeightProof154)
	...
	b154test = abcutil.NewBlock(badIndexProof154)
	...
	b154test = abcutil.NewBlock(badScrVal154)
	...
	b154test = abcutil.NewBlock(badScrValS154)
	...
	b154test = abcutil.NewBlock(invalMissingInsS154)
	...
	b154test = abcutil.NewBlock(malformedScr154)
	...
	b154test = abcutil.NewBlock(spendZeroValueIn154)
	...
	b166test := abcutil.NewBlock(spendInvalid166)
	...
	orgAddr, _ := abcutil.DecodeAddress("ScuQxvveKGfpG1ypt6u27F99Anf7EW3cqhq",
		simNetParams)
	pkScript, _ := txscript.GenerateSStxAddrPush(orgAddr,
		abcutil.Amount(29702992297), 0x0000)
	...
	b166test = abcutil.NewBlock(sstxSpendInvalid166)
	...
	pkScript, _ = txscript.GenerateSStxAddrPush(orgAddr,
		abcutil.Amount(2345438298), 0x0000)
	txOut = wire.NewTxOut(int64(0), pkScript)
	sstxToUse166.AddTxOut(txOut)
	pkScript, _ = txscript.PayToSStxChange(orgAddr)
	txOut = wire.NewTxOut(0, pkScript)
	...
	b166test = abcutil.NewBlock(sstxSpend2Invalid166)
	...
	b166test = abcutil.NewBlock(sstxSpend3Invalid166)
	...
	b166test = abcutil.NewBlock(regTxSpendStakeIn166)
...
func TestCheckBlockSanity(t *testing.T) {
	timeSource := blockchain.NewMedianTime()
	block := abcutil.NewBlock(&badBlock)
...
// simNetPowLimit is the highest proof of work value a Aero block
// can have for the simulation test network.  It is the value 2^255 - 1.
var simNetPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 255), bigOne)

// SimNetParams defines the network parameters for the simulation test Aero
