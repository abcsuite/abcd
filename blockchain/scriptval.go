...
func ValidateTransactionScripts(tx *abcutil.Tx, utxoView *UtxoViewpoint, flags txscript.ScriptFlags, sigCache *txscript.SigCache) error {
...
func checkBlockScripts(block *abcutil.Block, utxoView *UtxoViewpoint, txTree bool,
