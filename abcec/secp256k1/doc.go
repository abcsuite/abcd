...
/*
Package secp256k1 implements support for the elliptic curves needed for abcd.

Aero uses elliptic curve cryptography using koblitz curves
...
standard formats.  It was designed for use with abcd, but should be
