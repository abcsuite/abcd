...
import (
	...
	"github.com/abcsuite/abcd/addrmgr"
...
func addNaTests() {
	// IPv4
	// Localhost
	addNaTest("127.0.0.1", 9527, "127.0.0.1:9527")
	addNaTest("127.0.0.1", 9526, "127.0.0.1:9526")

	// Class A
	addNaTest("1.0.0.1", 9527, "1.0.0.1:9527")
	addNaTest("2.2.2.2", 9526, "2.2.2.2:9526")
	addNaTest("27.253.252.251", 9525, "27.253.252.251:9525")
	addNaTest("123.3.2.1", 9524, "123.3.2.1:9524")

	// Private Class A
	addNaTest("10.0.0.1", 9527, "10.0.0.1:9527")
	addNaTest("10.1.1.1", 9526, "10.1.1.1:9526")
	addNaTest("10.2.2.2", 9525, "10.2.2.2:9525")
	addNaTest("10.10.10.10", 9524, "10.10.10.10:9524")

	// Class B
	addNaTest("128.0.0.1", 9527, "128.0.0.1:9527")
	addNaTest("129.1.1.1", 9526, "129.1.1.1:9526")
	addNaTest("180.2.2.2", 9525, "180.2.2.2:9525")
	addNaTest("191.10.10.10", 9524, "191.10.10.10:9524")

	// Private Class B
	addNaTest("172.16.0.1", 9527, "172.16.0.1:9527")
	addNaTest("172.16.1.1", 9526, "172.16.1.1:9526")
	addNaTest("172.16.2.2", 9525, "172.16.2.2:9525")
	addNaTest("172.16.172.172", 9524, "172.16.172.172:9524")

	// Class C
	addNaTest("193.0.0.1", 9527, "193.0.0.1:9527")
	addNaTest("200.1.1.1", 9526, "200.1.1.1:9526")
	addNaTest("205.2.2.2", 9525, "205.2.2.2:9525")
	addNaTest("223.10.10.10", 9524, "223.10.10.10:9524")

	// Private Class C
	addNaTest("192.168.0.1", 9527, "192.168.0.1:9527")
	addNaTest("192.168.1.1", 9526, "192.168.1.1:9526")
	addNaTest("192.168.2.2", 9525, "192.168.2.2:9525")
	addNaTest("192.168.192.192", 9524, "192.168.192.192:9524")

	// IPv6
	// Localhost
	addNaTest("::1", 9527, "[::1]:9527")
	addNaTest("fe80::1", 9526, "[fe80::1]:9526")

	// Link-local
	addNaTest("fe80::1:1", 9527, "[fe80::1:1]:9527")
	addNaTest("fe91::2:2", 9526, "[fe91::2:2]:9526")
	addNaTest("fea2::3:3", 9525, "[fea2::3:3]:9525")
	addNaTest("feb3::4:4", 9524, "[feb3::4:4]:9524")

	// Site-local
	addNaTest("fec0::1:1", 9527, "[fec0::1:1]:9527")
	addNaTest("fed1::2:2", 9526, "[fed1::2:2]:9526")
	addNaTest("fee2::3:3", 9525, "[fee2::3:3]:9525")
	addNaTest("fef3::4:4", 9524, "[fef3::4:4]:9524")
}
...
func TestAttempt(t *testing.T) {
	...
	err := n.AddAddressByIP(someIP + ":9527")
	if err != nil {
...
func TestNeedMoreAddresses(t *testing.T) {
	...
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.%d.173.147:9527", i/128+60, i%128+60)
	...
	srcAddr := wire.NewNetAddressIPPort(net.IPv4(173, 144, 173, 111), 9527, 0)
...
func TestGood(t *testing.T) {
	...
	var err error
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.173.147.%d:9527", i/64+60, i%64+60)
		addrs[i], err = n.DeserializeNetAddress(s)
		if err != nil {
			t.Errorf("Failed to turn %s into an address: %v", s, err)
		}
