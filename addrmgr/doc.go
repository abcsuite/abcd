...
/*
Package addrmgr implements concurrency safe Aero address manager.

Address Manager Overview

In order maintain the peer-to-peer Aero network, there needs to be a source
of addresses to connect to as nodes come and go.  The Aero protocol provides
