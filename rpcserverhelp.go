...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, ABCD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"scriptpubkeyresult-addresses": "The abcd addresses associated with this script",
	...
	"decodescriptresult-addresses": "The abcd addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (abcd extension)",
	...
	"getcurrentnet--synopsis": "Get abcd network the server is running on.",
	...
	"infowalletresult-balance":         "The total abcd balance of the wallet",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in abcd",
	...
	"searchrawtransactions-address":     "The Aero address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (abcd does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown abcd.",
	"stop--result0":  "The string 'abcd stopping.'",
	...
	"validateaddresschainresult-address": "The abcd address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Aero address to validate",
	...
	"verifymessage-address":   "The abcd address to use for the signature",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*abcjson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*abcjson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"estimatestakediff":     {(*abcjson.EstimateStakeDiffResult)(nil)},
	...
	"getaddednodeinfo":      {(*[]string)(nil), (*[]abcjson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*abcjson.GetBestBlockResult)(nil)},
	"generate":              {(*[]string)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*abcjson.GetBlockVerboseResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*abcjson.GetBlockHeaderVerboseResult)(nil)},
	"getblocksubsidy":       {(*abcjson.GetBlockSubsidyResult)(nil)},
	"getblocktemplate":      {(*abcjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getconnectioncount":    {(*int32)(nil)},
	"getcurrentnet":         {(*uint32)(nil)},
	"getdifficulty":         {(*float64)(nil)},
	"getstakedifficulty":    {(*abcjson.GetStakeDifficultyResult)(nil)},
	"getstakeversioninfo":   {(*abcjson.GetStakeVersionInfoResult)(nil)},
	"getstakeversions":      {(*abcjson.GetStakeVersionsResult)(nil)},
	"getgenerate":           {(*bool)(nil)},
	"gethashespersec":       {(*float64)(nil)},
	"getheaders":            {(*abcjson.GetHeadersResult)(nil)},
	"getinfo":               {(*abcjson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*abcjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*abcjson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*abcjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]abcjson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*abcjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*abcjson.TxRawResult)(nil)},
	"getticketpoolvalue":    {(*float64)(nil)},
	"gettxout":              {(*abcjson.GetTxOutResult)(nil)},
	"getvoteinfo":           {(*abcjson.GetVoteInfoResult)(nil)},
	"getwork":               {(*abcjson.GetWorkResult)(nil), (*bool)(nil)},
	"getcoinsupply":         {(*int64)(nil)},
	"help":                  {(*string)(nil), (*string)(nil)},
	"livetickets":           {(*abcjson.LiveTicketsResult)(nil)},
	"missedtickets":         {(*abcjson.MissedTicketsResult)(nil)},
	"node":                  nil,
	"ping":                  nil,
	"rebroadcastmissed":     nil,
	"rebroadcastwinners":    nil,
	"searchrawtransactions": {(*string)(nil), (*[]abcjson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"ticketfeeinfo":         {(*abcjson.TicketFeeInfoResult)(nil)},
	"ticketsforaddress":     {(*abcjson.TicketsForAddressResult)(nil)},
	"ticketvwap":            {(*float64)(nil)},
	"txfeeinfo":             {(*abcjson.TxFeeInfoResult)(nil)},
	"validateaddress":       {(*abcjson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]abcjson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":                nil,
	"session":                     {(*abcjson.SessionResult)(nil)},
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := abcjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := abcjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
