...
//
// In addition to the main Aero network, which is intended for the transfer
...
// wire.AeroNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := abcutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard Aero networks,
