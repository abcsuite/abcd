...
var (
	...
	// mainPowLimit is the highest proof of work value a Aero block can
	// have for the main network.  It is the value 2^224 - 1.
	mainPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)

	// testNetPowLimit is the highest proof of work value a Aero block
...
// Params defines a Aero network by its parameters.  These parameters may be
// used by Aero applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Ticket pool sizes for Aero PoS. This denotes the number of possible
	...
	// Average number of tickets per block for Aero PoS.
...
// MainNetParams defines the network parameters for the main Aero network.
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "9527",
	DNSSeeds: []string{
		//"mainnet-seed.abcd.mindcry.org",
		//"mainnet-seed.abcd.netpurgatory.com",
		//"mainnet.aeroseed.org",
		//"mainnet-seed.abcd.org",
	},
	...
	Deployments: map[uint32][]ConsensusDeployment{
		4: {{
			...
			StartTime:  1530374400, // 2018-07-01
			ExpireTime: 1546272000, // 2019-01-01
		}},
	},
	...
	PubKeyAddrID:         [2]byte{0x05, 0x7c}, // starts with Ak
	PubKeyHashAddrID:     [2]byte{0x05, 0x66}, // starts with Ab
	PKHEdwardsAddrID:     [2]byte{0x05, 0x6e}, // starts with Ae
	PKHSchnorrAddrID:     [2]byte{0x05, 0x2a}, // starts with AB
	ScriptHashAddrID:     [2]byte{0x05, 0x69}, // starts with Ac
	PrivateKeyID:         [2]byte{0x22, 0xde}, // starts with Pm

	// BIP32 hierarchical deterministic extended key magics
	HDPrivateKeyID: [4]byte{0x02, 0xbf, 0x45, 0x2c}, // starts with aprv
	HDPublicKeyID:  [4]byte{0x02, 0xbf, 0x49, 0x67}, // starts with apub
...
var TestNet2Params = Params{
	...
	DefaultPort: "19527",
	DNSSeeds: []string{
		//"testnet-seed.abcd.mindcry.org",
		//"testnet-seed.abcd.netpurgatory.org",
		//"testnet.aeroseed.org",
		//"testnet-seed.abcd.org",
	},
...
var (
	// ErrDuplicateNet describes an error where the parameters for a Aero
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate Aero network")
...
// Register registers the network parameters for a Aero network.  This may
...
func ResetPubkey(params *Params){
	hdPrivToPubKeyIDs[params.HDPrivateKeyID] = params.HDPublicKeyID[:]
}
