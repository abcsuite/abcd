...
//
// The genesis block for Aero mainnet, testnet, and simnet are not evaluated
...
var genesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:    time.Unix(1498917600, 0), // Sat, 01 Jul 2017 22:00:00 GMT
		Bits:         0x1a01ffff,               // Difficulty 436338687
		SBits:        2 * 1e8,                  // 2 Coin
		Nonce:        0x00000000,
		StakeVersion: 0,
	},
