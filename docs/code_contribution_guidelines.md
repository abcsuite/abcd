...
reason, the abcd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire abcd
...
One of the major design goals of all core abcd packages is to aim for complete
...
contributions.  This is how to get your changes into abcd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/abcsuite/abcd/graphs/contributors)!
...
[ISC license](https://github.com/abcsuite/abcd/blob/master/LICENSE).  This is
the same license as all of the code in the abcd suite.
